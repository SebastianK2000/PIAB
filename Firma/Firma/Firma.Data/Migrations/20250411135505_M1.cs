    ...
    public partial class M1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kind", x => x.IdKind);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdReports = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reports", x => x.IdReports);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSupport = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdKinds = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => x.IdProduct);
                    table.ForeignKey(
                        name: "FK_Product_Kind_IdKinds",
                        column: x => x.IdKinds,
                        principalTable: "Kind",
                        principalColumn: "IdKind",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Product_IdProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_IdProducts",
                table: "Orders",
                column: "IdProducts");

            migrationBuilder.CreateIndex(
                name: "IX_Product_IdKinds",
                table: "Product",
                column: "IdKinds");
        }
