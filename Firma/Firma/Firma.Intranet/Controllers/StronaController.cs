...
namespace Firma.Intranet.Controllers
{
    public class StronaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,LinkTytul,Tytul,Content,Pozycja")] Strona strona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,LinkTytul,Tytul,Content,Pozycja")] Strona strona)
        {
